<footer>
        <div class="flex-wrapper">
            <div class="grid-unit-3">
                 <img class="footer-logo" src="assets/img/logo-white.png" alt="" srcset="">
            ...
            <div class="grid-unit-3">
                <h4 class="footer-col-title">Navigation</h4>
                 <ul class="footer-links">
                          <li class="nav-item"><a href="index.php" class="footer-nav-links">Acceuil</a></li>
                        <li><a class="footer-nav-links" href="http://">A Propos</a></li>
                        <li><a class="footer-nav-links" href="nos-programes.php">Nos formations</a></li>
                        <li><a class="footer-nav-links" href="energy-space.php">Energy Space</a></li>
                        <li><a class="footer-nav-links" href="blog.php">Blog et actualités</a></li>
                 </ul>
            </div>
            <div class="grid-unit-3">
     ...
     <script src="https://kit.fontawesome.com/f69535a4bf.js" crossorigin="anonymous"></script>
